...
* When adding additional menus or buttons, you made need to adjust the layout of the calendar title or position them absolutely.
*/
...
export default function Navbar({children, month, year}:NavbarProps):JSX.Element {
  return (
    <div className={"h-1/10 border-b-4 border-blue-500 bg-gray-900 "}>
